...
$time = [];
if ($query = $db->query("SELECT * FROM full_information_about_time")) {
...
<body>
    ...
    <form method="get">
        <div class="addItem-container">
            ...
            <input type="text" name="employee" placeholder="Виконавець"/>
            <input type="datetime-local" name="start_date" placeholder="Дата початку" />
            <input type="datetime-local" name="end_date" placeholder="Дата кінця" />
    ...
    <table class="styled-table">
        <thead>
            <tr>
                ...
                <td>Завдання</td>
                <td>Виконавець</td>
                <td>Дата початку виконання завдання</td>
                <td>Дата кінця виконання завдання</td>
                <td></td>
            </tr>
        </thead>
        <tbody>
