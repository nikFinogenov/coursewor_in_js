...
<body>
    ...
    <form method="get">
        <div class="add-container">
            ...
            <input type="text" name="messenger" placeholder="Месенджер"/>
            <textarea name="hard_skils" placeholder="Hard-skils"></textarea>
            <textarea name="soft_skils" placeholder="Soft-skils"></textarea>
            <input type="text" name="location" placeholder="Локація"/>
